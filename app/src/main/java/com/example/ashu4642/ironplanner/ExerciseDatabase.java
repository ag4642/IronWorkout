...
import java.sql.SQLException;
 ...
 public class ExerciseDatabase {
    ...
    public static final String[] KEYS_ALL =
            {ExerciseDatabase.KEY_ROWID,
             ExerciseDatabase.KEY_TITLE,
             ExerciseDatabase.KEY_GROUP,
             ExerciseDatabase.KEY_REPS,
             ExerciseDatabase.KEY_WEIGHT};
    ...
    public ContentValues createContentValues(String title, String group, String reps, String weight) {
        ...
        values.put(ExerciseDatabase.KEY_GROUP, Integer.parseInt(group));
    ...
    private static class ExerciseDBHelper extends SQLiteOpenHelper {
        private static final String DATABASE_CREATE =
                ...
                ExerciseDatabase.KEY_GROUP  + "integer not null, " +
